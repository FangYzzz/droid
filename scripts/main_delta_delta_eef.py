...
def main(args: Args):
    ...
    print(robot_state)
    eff_q = copy.deepcopy(robot_state["cartesian_position"][3:6])
    gripper = None
    while True:
            ...
            try:
                ...
                if actions_from_chunk_completed == 0 or actions_from_chunk_completed >= args.open_loop_horizon:
                    ...
                    request_data = {
                        ...
                        "observation/eef_position": curr_obs["cartesian_position"],
                    ...
                    # assert pred_action_chunk.shape == (10, 8)  # 10,8
                ...
                current_quat = R.from_euler('xyz', eef_state[3:6]).as_quat()
                q_action = action[3:7] 
                q_action += current_quat
                ...
                # R_cmd = R_delta @ R_state
                # R_cmd = R_state @ R_delta
